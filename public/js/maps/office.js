...
const STORY = {
  ...
  phases: {
    ...
    sweep: {
      title: '열여덟 개의 방',
      hint: '복도 벽의 화재경보기에 붙어 E 를 길게 누르면 그 구역 스프링클러가 돈다. 증거를 회수하거나 소각 장치를 끌 때도 저절로 돈다.',
      radio: '지휘부: 층 하나에 방이 열여덟이다. 문틈으로 먼저 확인해라. 급하면 복도의 화재경보기를 당겨라 — 그 구역에 물이 돈다.',
    },
    hvt: {
      title: '잠긴 회의실',
    ...
    clear: {
      title: '복도가 길다',
      hint: '잔여 인원은 방을 옮겨 다닌다. 남은 수가 셋 이하로 줄면 어느 구역에 있는지 목표에 뜬다.',
      radio: '지휘부: 잔여 인원이 방을 옮겨 다니고 있다. 복도에서 오래 서 있지 마라. 끝까지 못 찾으면 철수로 넘긴다.',
    },
    extract: {
      title: '정문 광장으로',
  ...
  mission: {
    ...
    pages: [
      ...
      },
      {
        ...
        body: '이 건물은 조용하지 않다. 서버실 냉각팬이 계속 돌고, 예약 인쇄가 밤에도 나오고, 아무도 안 탄 승강기가 층을 오간다. 경비는 그 소리에도 반응한다. 그리고 복도 벽마다 화재경보기가 붙어 있다 - 가까이 가면 화면 아래에 안내가 뜬다. E(또는 사용 버튼)를 길게 눌러 당기면 8초간 울리고, 2초 반 뒤 그 방화구역의 스프링클러가 18초간 돈다.',
        detail: '경보기를 못 찾아도 물은 돈다. 증거를 회수하거나 소각 장치를 끄면 그 구역의 소화 설비가 저절로 작동한다 - 회수한 자리를 빠져나오는 몇 초가 그만큼 유리해진다. 물이 도는 구역에서는 서로 잘 안 보이고 발소리도 묻힌다. 적에게도 똑같이 적용된다. 먼저 붙는 쪽이 이긴다.',
      },
      {
